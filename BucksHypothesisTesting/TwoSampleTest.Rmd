...
run_t_test(account_2023, "DistanceToArena", "STM", "less")

# running the t-test on the 2024 dataset
run_t_test(account_2024, "DistanceToArena", "STM", "less")
...
# running the t-test on the 2023 dataset
run_t_test(account_2023, "GamesAttended", "STM", "greater")

# running the t-test on the 2023 dataset
run_t_test(account_2024, "GamesAttended", "STM", "greater")
